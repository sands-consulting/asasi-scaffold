...
class FKMigrator
{
    ...
    protected $filePath = __DIR__.'/database/relationships.json';
    ...
    {
        file_put_contents($this->filePath, json_encode((object) $this->relationships));
    }

    protected function loadRelationships()
    {
        $this->relationships = json_decode(file_get_contents($this->filePath), true);
    }
