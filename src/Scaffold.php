...
class Scaffold
{
    ...
    protected function create()
    {
        ...
        $templates = [
            ...
            'datatable.tpl'                         => base_path("app/DataTables/{$this->params['ModelNames']}DataTable.php"),
            'repository.tpl'                        => base_path("app/Repositories/{$this->params['ModelNames']}Repository.php"),
            'request.tpl'                           => base_path("app/Http/Requests/{$this->params['ModelNames']}Request.php"),
    ...
    protected function remove()
    {
        $templates = [
            ...
            base_path("app/Http/Requests/{$this->params['ModelNames']}Request.php"),
            ...
            base_path("app/DataTables/{$this->params['ModelNames']}DataTable.php"),
            ...
            base_path("app/Http/Requests/_{$this->params['ModelNames']}Request.php"),
    ...
    protected function makeFieldsParams()
    {
        $this->params = $this->params + [
            ...
            'REQUESTS' => app('scaffold.request')->make($this->fields, $this->params, $this->relationships),
        ];
    }
